...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:rgb(5, 3, 55)">
        <div class="container-fluid">
            <a class="navbar-brand ms-5" href="https://www.instagram.com/rifana.srgh">Rif Ana Suryaningsih</a>
        ...
        <div class="row my-3">
            ...
            <div class="row">
                    ...
                    <form action="proses-pendaftaran.php" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukan Nama" autocomplete="off" require>
                            </div>

                            <div class="mb-3">
                                <label for="alamat">alamat</label>
                                <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Masukan Alamat" autocomplete="off" require>
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sekolah_asal" id="sekolah_asal" class="form-control" placeholder="Masukan Sekolah Asal" autocomplete="off" require>
                </div>
